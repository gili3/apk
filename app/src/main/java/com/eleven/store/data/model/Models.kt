...
// ─── Notification ──────────────────────────────────────────────
// مصدر الحقيقة الوحيد: users/{uid}/notifications (نفس المستند حرفياً الذي
// يقرأه/يكتبه السيرفر وموقع الويب — راجع notification-service.ts و
// shared/types.ts::AppNotification).
@IgnoreExtraProperties
